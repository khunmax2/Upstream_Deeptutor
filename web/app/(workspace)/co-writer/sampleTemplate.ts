...
export const CO_WRITER_SAMPLE_TEMPLATE = `# DeepWitya Co-Writer

> DeepWitya's built-in writing canvas for notes, reports, tutorials, and AI-assisted drafts.
...
- A practical starter draft for DeepWitya product docs and learning content

## Headers (Underline)

DeepWitya Learning Note
=============

DeepWitya Study Outline
-------------
...
The <abbr title="Large Language Model">LLM</abbr> layer powers DeepWitya while the <abbr title="Retrieval Augmented Generation">RAG</abbr> layer provides grounded knowledge support.

### Blockquotes

> DeepWitya helps students turn questions into structured understanding.
>
> "Learn deeply, write clearly.", [DeepWitya](#deepwitya-co-writer)

### Links

[DeepWitya Co-Writer](#deepwitya-co-writer "co-writer section")

[DeepWitya Learning Note](#deepwitya-learning-note)

[DeepWitya Website](https://deeptutor.info)

[Reference link][deeptutor-doc]

[deeptutor-doc]: #deepwitya-learning-note
...
> DeepWitya brand mark used inside the co-writer template.
...
- [x] Draft a DeepWitya product note
...
op=>operation: DeepWitya analyzes intent
...
${FENCE}seq
Student->DeepWitya: Ask for help
DeepWitya->KnowledgeBase: Load context
Note right of DeepWitya: Collect memory\\nand relevant knowledge
DeepWitya-->Student: Return guided response
Student->>DeepWitya: Request rewrite in co-writer
${FENCE}
