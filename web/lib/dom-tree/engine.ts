// @ts-nocheck — vendored third-party code, kept byte-identical apart from
// this header; do not lint-fix or type-annotate (eases re-vendoring).
/**
 * Vendored from Alibaba page-agent (MIT License)
 * https://github.com/alibaba/page-agent — packages/page-controller/src/dom/dom_tree
 * Copyright (c) 2026 SimonLuvRamen; Copyright (c) 2026 Alibaba Group Holding Limited
 * Itself a port from browser-use (MIT). Vendored unmodified for DeepTutor's
 * voice UI collector — see NOTICE for third-party attributions.
 *
