...
const GROUPS: DashboardGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        href: "/space/mcp",
        icon: Plug,
        title: { zh: "MCP 服务", en: "MCP Services", th: "บริการ MCP" },
        blurb: {
          zh: "连接托管 MCP 服务，把它们的工具带进对话。",
          en: "Connect hosted MCP services and bring their tools into chat.",
          th: "เชื่อมต่อบริการ MCP แบบโฮสต์ แล้วนำเครื่องมือของมันเข้ามาในแชต",
        },
        unit: { zh: "个服务", en: "services", th: "บริการ" },
      ...
      },
      {
        ...
        href: "/space/cli-apps",
        icon: Terminal,
        title: { zh: "CLI 应用", en: "CLI Apps", th: "แอป CLI" },
        blurb: {
          zh: "来自 CLI-Anything 目录的命令行工具，启用后对话可直接调用。",
          en: "Command-line tools from the CLI-Anything catalog, callable from chat.",
          th: "เครื่องมือบรรทัดคำสั่งจากแคตตาล็อก CLI-Anything เรียกใช้ได้จากแชต",
        },
        unit: { zh: "个应用", en: "apps", th: "แอป" },
  ...
  {
    label: { zh: "更多项目", en: "More Projects", th: "โปรเจกต์อื่น" },
    items: [
      {
        key: "whisper",
        href: "/whisper",
        icon: Ear,
        title: { zh: "密语", en: "Whisper", th: "กระซิบ" },
        blurb: {
          zh: "双席位咨询练习房间：督导只对受训者耳语。",
          en: "Dual-seat practice room — the supervisor whispers to the trainee only.",
          th: "ห้องฝึกให้คำปรึกษาแบบสองที่นั่ง — ผู้นิเทศกระซิบถึงผู้ฝึกเท่านั้น",
        },
