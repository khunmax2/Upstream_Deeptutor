    ...
    (
      ...
      if (readiness === "failed") {
        return {
          tone: "bad",
          dot: true,
          label: { zh: "测试失败", en: "Test failed", th: "ทดสอบล้มเหลว" },
        };
      }
      if (readiness === "passed") {
        return {
          tone: "ok",
          dot: true,
          label: { zh: "测试通过", en: "Test passed", th: "ทดสอบผ่าน" },
        };
      }
      if (readiness === "untested") {
        return {
          tone: "neutral",
          dot: true,
          label: { zh: "已配置", en: "Configured", th: "ตั้งค่าแล้ว" },
        };
      }
      return {
        tone: "neutral",
        dot: false,
        label: { zh: "未配置", en: "Not set", th: "ยังไม่ได้ตั้งค่า" },
      };
    },
