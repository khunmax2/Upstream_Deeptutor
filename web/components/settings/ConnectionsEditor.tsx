...
const SERVICE_LABEL: Record<ServiceName, { en: string; zh: string; th: string }> = {
  ...
  search: { en: "Search", zh: "搜索", th: "ค้นหา" },
  tts: { en: "Text-to-Speech", zh: "语音合成", th: "แปลงข้อความเป็นเสียง" },
  stt: { en: "Speech-to-Text", zh: "语音识别", th: "แปลงเสียงเป็นข้อความ" },
  imagegen: { en: "Image", zh: "文生图", th: "สร้างภาพ" },
  videogen: { en: "Video", zh: "文生视频", th: "สร้างวิดีโอ" },
};
