    ...
    return (
      <aside className="group/sb relative flex h-dvh w-[60px] shrink-0 flex-col items-center bg-[var(--secondary)] py-3 transition-all duration-200">
        ...
        <div className="flex w-full flex-col items-center gap-1 px-1.5">
          ...
          {renderedFooter}
          {/* Fork: these point at upstream's docs and repo, which this
              build does not present as its own. The gate stays; what it
              wraps is upstream's current markup. */}
          {UPSTREAM_LINKS_ENABLED ? (
            <>
              <a
                href={DOCS_URL}
